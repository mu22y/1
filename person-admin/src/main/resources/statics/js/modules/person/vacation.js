$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'person/vacation/list',
        datatype: "json",
        colModel: [
    ...
    methods: {
        ...
        del: function () {
            ...
            confirm('确定要删除选中的记录？', function () {
                $.ajax({
                    type: "POST",
                    url: baseURL + "person/vacation/delete",
        ...
        saveOrUpdate: function () {
            var url = vm.apply.id == null ? "person/vacation/save" : "person/vacation/approval";
            $.ajax({
                type: "POST",
                url: baseURL + url,
                contentType: "application/json",
        ...
        getRecord: function (id) {
            $.get(baseURL + "person/vacation/info/" + id, function (r) {
                vm.apply = r.apply;
            });
        },
        reload: function () {
