$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'person/evection/list',
        datatype: "json",
        colModel: [
    ...
    methods: {
        ...
        del: function () {
            ...
            confirm('确定要删除选中的记录？', function () {
                $.ajax({
                    type: "POST",
                    url: baseURL + "person/evection/delete",
        ...
        saveOrUpdate: function () {
            var url = vm.apply.id == null ? "person/evection/save" : "person/evection/approval";
            $.ajax({
                type: "POST",
                url: baseURL + url,
                contentType: "application/json",
        ...
        getRecord: function (id) {
            $.get(baseURL + "person/evection/info/" + id, function (r) {
                vm.apply = r.apply;
            });
        },
        reload: function () {
